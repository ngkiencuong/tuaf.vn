...
const Qltntn = dynamic(
  () => import("@/features/nganh-qltntn").then((mod) => mod.Qltntn),
  {
    loading: () => <Loading />
  }
);
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const api_url_seo = `${api_rm_url}/nganh-quan-ly-tai-nguyen-va-moi-truong`;
...
const Page = (props: IPostPage) => {
  ...
  return (
    <>
      ...
      <Qltntn qltntn={props.home_content?.acf?.qltntn} />
    </>
  );
};
